...
public abstract class AbstractRenderer implements Cloneable, Serializable
{
  ...
  protected Object clone() throws CloneNotSupportedException
  {
    ...
    try
    {
      ...
      {
        clone.itemLabelFontMap = (Map) ((HashMap) this.itemLabelFontMap).clone();
      }
    }
    ...
    try
    {
      ...
      {
        clone.positiveItemLabelPositionMap = (Map<Integer, ItemLabelPosition>) ((HashMap) this.positiveItemLabelPositionMap).clone();
      }
    }
    catch (Exception ignored)
    {
    ...
    try
    {
      ...
      {
        clone.negativeItemLabelPositionMap = (Map<Integer, ItemLabelPosition>) ((HashMap) this.negativeItemLabelPositionMap).clone();
      }
    }
    catch (Exception ignored)
    {
    ...
    try
    {
      ...
      {
        clone.legendTextFontMap = (Map) ((HashMap) this.legendTextFontMap).clone();
      }
    }
    catch (Exception ignored)
    {
