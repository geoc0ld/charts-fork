    ...
    ChartMouseListenerFX
{
  ...
  public ChartViewer(JFreeChart chart, boolean contextMenuEnabled)
  {
    ...
    this.contextMenu.setOnHiding(new EventHandler<WindowEvent>()
    {
      @Override public void handle(WindowEvent event)
      {
  ...
  private ContextMenu createContextMenu()
  {
    ...
    pngItem.setOnAction(new EventHandler<ActionEvent>()
    {
      ...
      {
        ChartViewer.this.handleExportToPNG();
      }
    });
    export.getItems().add(pngItem);
    
    MenuItem jpegItem = new MenuItem("JPEG...");
    jpegItem.setOnAction(new EventHandler<ActionEvent>()
    {
      @Override public void handle(ActionEvent e)
      {
        ChartViewer.this.handleExportToJPEG();
      }
    });
    ...
    if (ExportUtils.isOrsonPDFAvailable())
    {
      ...
      pdfItem.setOnAction(new EventHandler<ActionEvent>()
      {
        @Override public void handle(ActionEvent e)
        {
          ChartViewer.this.handleExportToPDF();
        }
      });
    ...
    if (ExportUtils.isJFreeSVGAvailable())
    {
      ...
      svgItem.setOnAction(new EventHandler<ActionEvent>()
      {
        @Override public void handle(ActionEvent e)
        {
          ChartViewer.this.handleExportToSVG();
        }
      });
